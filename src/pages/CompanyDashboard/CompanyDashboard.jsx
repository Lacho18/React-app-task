    ...
    <div className="bg-white text-[#08075F]">
      <div className="container mx-auto my-12 p-6 bg-white shadow-lg rounded-lg text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-center">
          <Link
            to="/company-dashboard/active-jobs"
            className="p-4 bg-blue-100 hover:bg-blue-200 rounded-lg block"
          >
          ...
          <Link
            to="/company-dashboard/cv-library"
            className="p-4 bg-blue-100 hover:bg-blue-200 rounded-lg block"
          >
          ...
          <Link
            to="/company-dashboard/questionnaires"
            className="p-4 bg-blue-100 hover:bg-blue-200 rounded-lg block"
          >
          ...
          <Link
            to="/company-dashboard/new-job"
            className="p-4 bg-blue-100 hover:bg-blue-200 rounded-lg block"
          >
            <h2 className="text-xl font-bold">Нова обява</h2>
            <p>Създайте нова обява за работа</p>
          </Link>
          ...
          <Link
            ...
            className="p-4 bg-blue-100 hover:bg-blue-200 rounded-lg block"
          >
            <h2 className="text-xl font-bold">Нов въпросник</h2>
            <p>Създайте нов въпросник за обява за работа</p>
          </Link>
        </div>
      </div>
    </div>
